...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    {
      title: "Help & support",
      url: "mailto:singhraspreet921@gmail.com",
      icon: Headphones,
    },
  ];
              ...
              appearance={{
                elements: {
                  ...
                  organizationSwitcherTrigger:
                    "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! gap-3! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:p-1! shadow-[0px_1px_1px_0px_rgba(44,54,53,0.03),inset_0px_0px_0px_2px_white]!",
